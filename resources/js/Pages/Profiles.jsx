...
{/* ----------------------------------------------------------------------------------------------------------------------------------------- */}
    <div className="flex items-center flex-col mt-10">
        <div className="bg-neutral-300 w-1/3">
            <h1>Username: {user.name}</h1>
            <p>E-Mail: {user.email}</p>
            <p>Current Balance: {user.balance}€</p>
            <p>User ID: {user.id}</p>
        </div>
        <img className="w-1/3" src="https://imgs.search.brave.com/BF27SbH9q01MS3SzPoI_UUgdxlpeVbC02T82crM3Dts/rs:fit:500:0:1:0/g:ce/aHR0cHM6Ly93d3cu/cmQuY29tL3dwLWNv/bnRlbnQvdXBsb2Fk/cy8yMDE4LzEyLzUw/LUZ1bm55LUFuaW1h/bC1QaWN0dXJlcy1U/aGF0LVlvdS1OZWVk/LUluLVlvdXItTGlm/ZS04LmpwZz9maXQ9/NzAwLDQ2Nw" alt="" />
    </div>
